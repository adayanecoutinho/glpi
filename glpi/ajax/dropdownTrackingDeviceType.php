...
if (isset($_POST["itemtype"]) && CommonITILObject::isPossibleToAssignType($_POST["itemtype"])) {
   ...
   Ajax::updateItemOnInputTextEvent("search_" . $_POST['myname'] . $rand, "results_ID$rand", $CFG_GLPI["root_doc"] . "/ajax/dropdownFindNum.php", $paramstrackingdt);
    //die(var_export(Ajax::updateItemOnInputTextEvent("search_" . $_POST['myname'] . $rand, "results_ID$rand", $CFG_GLPI["root_doc"] . "/ajax/dropdownFindNum.php", $paramstrackingdt)));
